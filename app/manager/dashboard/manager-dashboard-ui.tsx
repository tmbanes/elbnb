...
import {
    ...
    ChevronLeft, Filter, User, Plus, RotateCcw, Clock, Send
} from "lucide-react";
import {
    Dialog,
    DialogContent,
...
export default function ManagerDashboardUI({ onLogout, isLoggingOut }: ManagerDashboardUIProps) {
    ...
    if (!hasMounted) {
        return <div className={`flex h-screen bg-[#F6F5ED] overflow-hidden ${archivo.className}`} />;
    }
                ...
                <div className="px-8 lg:px-16 xl:px-24 flex-1 overflow-auto pb-10" suppressHydrationWarning>
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-[13px] text-slate-500 font-medium">
                            {dashboardView === 'operations' ? 'Real-time oversight of the Makiling Residence Hall.' : 'Financial health and collection management.'}
                        </p>
                    </div>
                    ...
                    <div className="flex bg-slate-200/50 p-1 rounded-xl w-fit mb-8 border border-slate-200">
                        <button
                            ...
                            className={`px-6 py-2 text-[12px] font-black uppercase tracking-widest rounded-lg transition-all ${dashboardView === 'operations' ? 'bg-[#0B3A64] text-white shadow-md' : 'text-slate-500 hover:text-slate-700'}`}
                            suppressHydrationWarning
                        >
                            Operations
                        </button>
                        <button
                            onClick={() => setDashboardView('financials')}
                            className={`px-6 py-2 text-[12px] font-black uppercase tracking-widest rounded-lg transition-all ${dashboardView === 'financials' ? 'bg-[#5591AB] text-white shadow-md' : 'text-slate-500 hover:text-slate-700'}`}
                            suppressHydrationWarning
                        >
                            Financials
                        </button>
                                                    ...
                                                    {activeTab === 'residents' ? (
                                                        ...
                                                        <td className="py-5 px-2 text-right">
                                                            <span className="text-[13px] font-medium text-slate-600">
                                                                {hasMounted ? new Date(student.date_approved).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : "---"}
                                                            </span>
                                                        </td>
                                                    )}
                        ...
                        <div className="space-y-8 animate-in fade-in duration-500">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100/50 flex flex-col justify-between h-[160px]">
                                            ...
                                            <div>
                                                <p className="text-[32px] font-black text-[#0B3A64] leading-none mb-1">₱245,000.00</p>
                                        ...
                                        <div className="bg-[#EBF2E1] rounded-[24px] p-6 shadow-sm flex flex-col justify-between h-[160px] relative overflow-hidden">
                                            <div className="absolute -right-4 -bottom-4 opacity-10 text-[#7A9D54]">
                                                <CheckCircle2 className="w-24 h-24" />
                                            </div>
                                            <div className="flex justify-between items-start relative z-10">
                                                <h3 className="text-[10px] font-bold text-[#7A9D54] tracking-[0.1em] uppercase">Actual Collected</h3>
                                                <span className="bg-[#7A9D54] text-white text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">78% Paid</span>
                                            </div>
                                            <div className="relative z-10">
                                                <p className="text-[32px] font-black text-[#443322] leading-none mb-1">₱192,500.00</p>
                                                <div className="w-full h-1.5 bg-[#D5E1CD] rounded-full mt-3 overflow-hidden">
                                                    <div className="w-[78%] h-full bg-[#7A9D54] rounded-full"></div>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="bg-[#FDECEB] rounded-[24px] p-6 shadow-sm flex flex-col justify-between h-[160px] relative overflow-hidden">
                                            <div className="absolute -right-4 -bottom-4 opacity-10 text-[#DE7A6A]">
                                                <AlertTriangle className="w-24 h-24" />
                                            </div>
                                            <div className="flex justify-between items-start relative z-10">
                                                <h3 className="text-[10px] font-bold text-[#DE7A6A] tracking-[0.1em] uppercase">Outstanding Balance</h3>
                                                <span className="bg-[#DE7A6A] text-white text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Urgent</span>
                                            </div>
                                            <div className="relative z-10">
                                                <p className="text-[32px] font-black text-[#443322] leading-none mb-1">₱52,500.00</p>
                                                <p className="text-[11px] text-[#DE7A6A] font-bold uppercase tracking-wider mt-2">14 Unpaid Invoices</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white rounded-[24px] shadow-sm border border-slate-100/50 overflow-hidden">
                                        <div className="px-10 py-8 border-b border-slate-50 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
                                            ...
                                            <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
                                                <div className="flex items-center gap-2 bg-[#F8F9FD] px-3 py-1 rounded-full border border-slate-100">
                                                    <Select value={tableFilters.paymentStatus} onValueChange={(v) => setTableFilters(prev => ({ ...prev, paymentStatus: v }))}>
                                                        <SelectTrigger className="h-8 border-none bg-transparent text-[11px] font-bold text-[#0B3A64] focus:ring-0 w-[120px] p-0 px-2">
                                                ...
                                                <button className="flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-full text-[12px] font-bold hover:bg-slate-50 transition-all shadow-sm">
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="w-full text-left border-collapse">
                                                ...
                                                <tbody>
                                                    {[
                                                        { name: "Julian Martinez", room: "Unit 104", amount: "₱3,500.00", days: "12 Days", status: "Overdue", pic: "JM" },
                                                        { name: "Sarah Jenkins", room: "Unit 212", amount: "₱1,750.00", days: "02 Days", status: "Unpaid", pic: "SJ" },
                                                        { name: "Michael Chen", room: "Unit 108", amount: "₱3,500.00", days: "08 Days", status: "Overdue", pic: "MC" },
                                                        { name: "Lia Rodriguez", room: "Unit 305", amount: "₱1,750.00", days: "01 Day", status: "Unpaid", pic: "LR" },
                                                    ].map((item, idx) => (
                                                        <tr key={idx} className="border-b border-slate-50 last:border-0 group hover:bg-[#F9FBFD] transition-colors">
                                                            <td className="py-5 px-10">
                                                                <div className="flex items-center gap-4">
                                                                    <div className="w-10 h-10 rounded-full bg-[#5D6BDE] text-white flex items-center justify-center font-bold text-xs shadow-sm">
                                                                        {item.pic}
                                                                    </div>
                                                                    <div>
                                                                        <p className="text-[14px] font-black text-[#0B3A64] leading-none mb-1.5">{item.name}</p>
                                                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Resident since Aug 2025</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td className="py-5 px-4">
                                                                <span className="text-[13px] font-black text-[#0B3A64]">{item.room}</span>
                                                            </td>
                                                            <td className="py-5 px-4">
                                                                <span className="text-[14px] font-black text-[#DE7A6A]">{item.amount}</span>
                                                            </td>
                                                            <td className="py-5 px-4">
                                                                <div className="flex items-center gap-2">
                                                                    <Clock className="w-3.5 h-3.5 text-slate-300" />
                                                                    <span className="text-[13px] font-bold text-slate-600">{item.days}</span>
                                                                </div>
                                                            </td>
