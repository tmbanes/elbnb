                    ...
                    {dashboardView === 'operations' ? (
                        <>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                                ...
                                {/* Maintenance Overview - static for now */}
                                <div className="bg-[#22446A] text-white rounded-[20px] p-6 shadow-sm flex flex-col relative overflow-hidden">
                                    <div className="absolute -right-10 -bottom-10 opacity-5"><Building2 className="w-48 h-48" /></div>
                                    <h3 className="text-[10px] font-bold text-white/70 tracking-[0.15em] uppercase mb-4 relative z-10">Maintenance Overview</h3>
                                    <div className="relative z-10 mb-4">
                                        <p className="text-[42px] font-black leading-none">14</p>
                                        <p className="text-[13px] font-bold text-white/60 mt-1">Open</p>
                                    </div>
                                    <div className="flex items-center gap-3 mb-4 relative z-10">
                                        <p className="text-[12px] font-bold text-white/70 tracking-wider uppercase">84% Resolution Rate</p>
                                    </div>
                                    <div className="w-24 h-1 bg-[#1A3355] rounded-full mb-6 overflow-hidden relative z-10">
                                    ...
                                    <button className="w-full mt-auto py-3 bg-[#BBE0F9] hover:bg-[#A3D0EF] text-[#0B3A64] text-[12px] font-bold rounded-lg transition-colors shadow-sm relative z-10 tracking-widest uppercase">Generate Report</button>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[20px] p-6 shadow-sm border border-slate-100/50">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <button className="text-[10px] font-bold text-slate-400 hover:text-slate-600 uppercase tracking-widest flex items-center gap-1 transition-colors">View Historical Data <ChevronRight className="w-3.5 h-3.5" /></button>
                                </div>
                                {activityLog.length > 0 ? (
                                        ...
                                        {activityLog.map((log: any) => (
                                            <div key={log.log_id} className="flex items-center justify-between">
                                                <div className="flex items-start gap-4">
                                                    <div className="mt-1 w-2.5 h-2.5 rounded-full flex-shrink-0" style={{ backgroundColor: activityColor(log.action_type) }}></div>
                                                    <div>
                                                        <p className="text-[13px] text-slate-800 font-medium">
                                                            ...
                                                            {log.user_role && <span className="text-slate-500"> · {log.user_role}</span>}
                                                        </p>
                                                        {log.log_desc && <p className="text-[11px] text-slate-500 mt-0.5">{log.log_desc}</p>}
                                                    </div>
                                                </div>
                                                <span className="text-[10px] text-slate-400 font-bold flex-shrink-0 ml-4">
                                    ...
                                    <p className="text-center text-slate-300 text-sm font-bold uppercase tracking-widest py-8">No recent activity</p>
                                )}
                            </div>
                        </>
                    ) : (
