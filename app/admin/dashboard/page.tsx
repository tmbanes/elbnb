...
export default async function AdminDashboardPage() {
  ...
  const [
    ...
    supabase.from("accommodation_application").select("application_id, user_id, application_status, date_submitted, preferred_accommodation_id, preferred_unit_type, duration_of_stay, check_in, check_out, number_of_companions, users(first_name, last_name, email, sex), accommodation(name)").in("application_status", ["pending_admin", "pending_dorm_manager"]).order("date_submitted", { ascending: false }),
    supabase.from("accommodation_application").select("application_id, user_id, application_status, date_submitted, preferred_unit_type, duration_of_stay, check_in, check_out, number_of_companions, users(first_name, last_name, email, sex), accommodation(name)").order("date_submitted", { ascending: false }).limit(8),
