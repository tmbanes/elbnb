  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-4 border-b border-gray-100 pb-4">
        <Link href="/">
          <button className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 px-3 py-2 rounded-md transition-colors border border-gray-200 shadow-sm">
