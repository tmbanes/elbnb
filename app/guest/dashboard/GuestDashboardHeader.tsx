...
export function GuestDashboardHeader({ profile, initialNotifications }: GuestDashboardHeaderProps) {
    ...
    return (
        <header className="flex flex-col-reverse md:flex-row justify-end items-start md:items-center w-full mb-12 gap-4 relative z-50">
