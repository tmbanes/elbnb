...
export default function StudentDashboardUI({ onLogout, isLoggingOut }: StudentDashboardUIProps) {
          ...
          <div className="lg:col-span-2 bg-[#FDFFF4] rounded-[24px] p-6 md:p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[#eef1d6] relative overflow-hidden flex flex-col justify-between">
            <div>
              ...
              <h2 className="text-2xl md:text-[28px] font-bold text-[#2A3F2D] mb-1 leading-tight flex items-center gap-2">
                Makiling Residence Hall, Room 302 <ArrowRight className="w-6 h-6 text-[#8BAE90] stroke-[1.5]" />
              </h2>
            ...
            <div className="mt-2">
              <Link href="/student/history">
                <button className="w-full py-3.5 bg-[#5591AB] hover:bg-[#4a7d94] text-white text-[13px] font-bold rounded-xl transition-all shadow-[0_2px_8px_rgba(85,145,171,0.3)] flex items-center justify-center gap-2 group active:scale-[0.98] cursor-pointer">
                  Accommodation History <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </button>
              </Link>
            </div>
          </div>
              ...
              <div className="space-y-3 mb-8">
                <div className="bg-[#F8F9EC] rounded-[14px] p-3 pl-4 flex justify-between items-center border border-[#eef1d6] group hover:bg-[#f3f5e1] transition-colors cursor-pointer">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <p className="text-[13px] font-bold text-slate-900 mb-0.5">Student_ID_Scan.pdf</p>
